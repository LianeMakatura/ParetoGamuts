classdef Gridshell_nonsymb
    ...
    methods
        function obj = Gridshell_nonsymb(basewd, numX, numY, perfMetricIDs)
            %PROBLEMTEMPLATE - constructor for the class. Named same as
            % class.
            %   Detailed explanation goes here
            obj.problemName = "Gridshell_nonsymb"; %shouldn't have any spaces or special chars except underscore
            ...
            numFixedBoundaryPts = 0;%obj.N - (numX-2)*(numY-2);
...
%             variablePts = reshape(lerp(obj.xSymb, 0, 5), numX-2, numY-2);
            variablePts = reshape(lerp(obj.xSymb, 0, 3), numX, numY);
