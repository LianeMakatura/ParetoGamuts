classdef Schulz_Turbine
    ...
    methods
        function obj = Schulz_Turbine(basewd, perfMetricIDs, fixed_context)
            %PROBLEMTEMPLATE - constructor for the class. Named same as
            % class.
            %   Detailed explanation goes here
            obj.problemName = "Schulz_Turbine"; %shouldn't have any spaces or special chars except underscore
            ...
            obj.rA = 1; 
            appNames = ["Wind Speed"];
            obj.zSymb = fixed_context; % need to have at least 1 symbolic var for the framework to be happy. Just don't use it if there shouldn't be one.
