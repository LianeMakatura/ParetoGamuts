classdef bicopter_2_contexts < handle
    ...
    methods
        function obj = bicopter_2_contexts(basewd)
            %PROBLEMTEMPLATE - constructor for the class. Named same as
            % class.
            %   Detailed explanation goes here
            obj.problemName = "bicopter_2_contexts"; %shouldn't have any spaces or special chars except underscore
...
%             end
            ...
            obj.rA = 2; 
            appNames = ["length of the bicopter", "density of the bicopter", ];
            obj.zSymb = sym('z', [max(1, obj.rA), 1]); % need to have at least 1 symbolic var for the framework to be happy. Just don't use it if there shouldn't be one.
            % Create aliases for the variables so they're meaningful, 
        ...
        function [f1, g1, h1] = performanceMetric1(obj)
            ...
            [f1, g1, h1] = bicopter_2_contexts_setup(obj.xSymb, obj.zSymb, 'position');
        ...
        function [f2, g2, h2] = performanceMetric2(obj)
            ...
            [f2, g2, h2] = bicopter_2_contexts_setup(obj.xSymb, obj.zSymb, 'energy'); 
        ...
        function [rfun, rf, rfuncsCell, rderiv, rhess] = createProblem(obj, createFiles)
            ...
            if obj.hasoptimizesampling
                obj.objfunc = cell(2);
                [obj.objfunc{1}, obj.objfunc{2}, ~]= bicopter_2_contexts_setup(sym('x_tmp', [obj.rD,1]), sym('z_tmp', [obj.rA,1]), 'both');
            end
