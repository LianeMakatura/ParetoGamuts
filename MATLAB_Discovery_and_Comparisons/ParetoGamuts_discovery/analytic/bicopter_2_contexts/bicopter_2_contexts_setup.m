function [fh, gradh, hessh] = bicopter_2_contexts_setup(design_variables, app_variables, performance_type)
    ...
    app_length = app_variables(1);
    app_length_scale = lerp(app_length, 0.5, 1.0);
    app_density = app_variables(2);
    app_density_scale = lerp(app_density, 0.5, 1.5);
%     app_variables_scale = lerp(app_variables, 0.5, 1.0); % 10.5 (m=r, false)
    ...
    m = app_length_scale * app_density_scale; %; 
    r = app_length_scale;
