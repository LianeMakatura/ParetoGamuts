classdef ZDT1
    ...
    methods
        function obj = ZDT1(rD, rA, basewd)
...
%             % treat z1 as the special element
%             x1 = obj.zSymb(1); 
%             s = sum(obj.zSymb(2:end)) + sum(obj.xSymb(1:end)); % remaining z vars and all x
%             g = 1 + 9*s / (obj.rD + obj.rA - 1);
